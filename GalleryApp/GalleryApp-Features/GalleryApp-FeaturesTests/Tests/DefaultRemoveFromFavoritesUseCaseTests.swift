//
//  DefaultRemoveFromFavoritesUseCaseTests.swift
...
// MARK: - DefaultRemoveFromFavoritesUseCaseTests
final class DefaultRemoveFromFavoritesUseCaseTests: XCTestCase {
    
    // MARK: Properties
    private var sut: DefaultRemoveFromFavoritesUseCase!
    private var mockRequest: FavoriteImage!
    ...
    override func setUpWithError() throws {
        ...
        sut = DefaultRemoveFromFavoritesUseCase()
        mockRequest = GalleryFeaturesMocks.requestFavoriteImage
